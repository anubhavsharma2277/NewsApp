...
import com.anubhav.newsapp.util.Constants
import com.anubhav.newsapp.util.Utils
...
class NewsRepository {
    ...
    fun fetchNewsList(): MutableLiveData<BaseModel<ArrayList<NewsData>>> {
        ...
        val postListInfo: Call<BaseModel<ArrayList<NewsData>>> =
            newsApi.getNewsTypes("in", Constants.NEWS_API_KEY, 50)
